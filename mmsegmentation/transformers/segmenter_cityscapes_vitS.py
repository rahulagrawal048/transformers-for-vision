...
cfg.load_from = 'checkpoints/vit_small_p16_384.pth'
#cfg.load_from = './saved_models/segmen/latest.pth'

# Set up working dir to save files and logs.
cfg.work_dir = './saved_models/small_segmenter'
...
get_ipython().system('jupyter nbconvert --to script segmenter_cityscapes.ipynb')
'''
